...
import service from './About.module.css';
import { serviceProvider } from './serviceProviderInfo';
const About = () => {
    ...
    return (
        <div className='h-auto'>
            <div className="w-full lg:h-auto sm:h-auto xsm:h-auto bg-purple-50 rounded-lg my-6 lg:flex lg:items-center lg:justify-between p-3">
            <section className="lg:w-[43%] sm:w-full xsm:w-full  h-full bg-blue-50 flex items-center justify-center sm:py-3 xsm:py-3 lg:py-0">
                ...
                <section className="lg:w-[48%] sm:w-full xsm:w-full h-full">
                    ...
                    <p className="text-gray-700 my-3">
                    At RoomBridge, we're dedicated to helping you bridge the gap between ideas and execution.
                    </p>
                </section>      
            </div>
            <div className="w-[100%] h-auto xsm:h-auto my-6 bg-purple-50 p-3 rounded-lg">
            ...
            <div className="w-full lg:h-auto sm:h-auto xsm:h-auto bg-purple-50 rounded-lg my-6 lg:flex lg:items-center lg:justify-between p-3">
                <section className="lg:w-[43%] sm:w-full xsm:w-full  h-full bg-blue-50 rounded-lg flex items-center justify-center sm:py-3 xsm:py-3 lg:py-4">
                    <img style={{borderRadius:'10px'}} width={450} src={aboutus} alt="" />   
                </section>
                <section className="lg:w-[48%] sm:w-full xsm:w-full h-full">
