...
const Testimonials = () => {
    ...
    return (
        <div className={`${reviews.main} w-full sm:w-full xsm:w-full  h-[450px] xsm:h-auto sm:h-auto flex items-center justify-between my-6 `}>
            <section className="lg:w-[565px] sm:w-full m-b xsm:w-full h-full  p-3  bg-purple-50 rounded-lg xsm:mb-3 lg:mb-0 md:mb-0">
                <p className='my-6 text-3xl font-bold text-gray-700 sm:text-center xsm:text-center lg:text-left'>CUSTOMER TESTIMONIALS</p>
                <div className='w-full h-[340px] m-auto '>
                    <Slider {...settings}>
                        {
                                ...
                                return (
                                    <div className=''>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-center'>{review.role}</p>
                                            
                                            <p className='text-center font-semibold'>Feedback: {review.reviews}</p>
                                        </div>
